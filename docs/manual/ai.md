...
![Nixi on the default desktop: an install question answered with the Packages panel, a written FAQ answer, then in Mechanic the whole command shown for approval, and the change undone](../img/features/nixi.gif)
